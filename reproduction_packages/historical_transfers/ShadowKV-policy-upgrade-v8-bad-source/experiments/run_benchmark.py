...
def _apply_shadowkv_policy_preset(
    ...
    *,
    ...
    token_benefit_ms = float(calibration.get('ms_per_token', tuned.get('ms_per_token', 1.0)))
...
def main() -> None:
    ...
    parser.add_argument('--disable_utility_admission', action='store_true', help='Disable Phase 3 online utility-aware admission for ShadowKV++ exact-prefix paths.')
