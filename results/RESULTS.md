...
This directory contains measured result families, selected raw traces, compact
...
| `fidelity_examples/` | Selected per-sample custom-splice agreement records. |
...
the larger family directories retain the underlying aggregates and selected
raw provenance.
