...
sglang:evicted_tokens_total{cache_type="SWARadixCache"} 42
# HELP sglang:eviction_duration_seconds Physical eviction duration.
sglang:eviction_duration_seconds_count{cache_type="SWARadixCache"} 1
sglang:eviction_duration_seconds_sum{cache_type="SWARadixCache"} 0.01
"""
