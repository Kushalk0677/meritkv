...
# Runtime APC-style systems need stable exact prefixes to show meaningful cache
# behavior. Keep raw/semantic for targeted ablations, but make the default
# Colab/runtime comparison prefix-rich.
