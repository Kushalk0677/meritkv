...
cp -- "${ROOT}/run_native_execute_bypass.py" "${ROOT}/run_experiment.sh" "${ROOT}/run_blackwell.sh" "${ROOT}/run_remote_experiment.py" "${ROOT}/finalize_manifest.py" "${ROOT}/requirements.txt" "${OUTPUT_DIR}/executed_inputs/"
