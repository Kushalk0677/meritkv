    ...
    for seed in args.seeds:
        ...
        for length in args.prefix_lengths:
            ...
            for warm_arm in ("native_apc", "meritkv_write_through", "meritkv_enforced"):
                ...
                first = client.complete(representative["prefix_token_ids"], arm_salt, args.max_tokens)
                second = client.complete(representative["prefix_token_ids"], arm_salt, args.max_tokens)
                warm_rows.append(
