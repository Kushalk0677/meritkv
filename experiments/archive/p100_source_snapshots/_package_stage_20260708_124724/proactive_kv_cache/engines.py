...
class ShadowKVPlusEngine(ShadowKVEngine):
    ...
    def __init__(
        ...
        self.learned_policy_threshold = max(0.0, min(float(learned_policy_threshold), 1.0))
    ...
    def _apply_outcome_exploration(
        ...
        *,
        ...
        if plan.strategy != 'bypass' or not self._should_explore_outcome(tokens):
