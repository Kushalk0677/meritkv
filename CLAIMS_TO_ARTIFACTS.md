...
**Public release:** The aggregate raw JSON is not included in this public snapshot; see the detailed report below.
...
**Public release:** The aggregate raw JSON is not included in this public snapshot; see the report below.
...
**Released artifacts:** `results/memory_bound_trace/qwen2.5/` and `results/memory_bound_trace/gemma4/` contain the Blackwell traces; T4/Phi is summary-only in this public snapshot.

**Detailed report:** `results/memory_bound_trace/MEMORY_BOUND_RESULTS.md`
...
## 14. Controlled vs Realistic Dual Validation
...
| MeritKV versus cost-only / MeritKV-Sem | `results/mixed_traffic/MIXED_TRAFFIC_RESULTS.md` | Aggregate raw JSON not included | `run_admission_baselines.py` |
| Blackwell admission baselines | `results/mixed_traffic/MIXED_TRAFFIC_RESULTS.md` §1.3 | Aggregate raw JSON not included | `run_admission_baselines.py` |
| Memory-bound recovery | `results/memory_bound_trace/MEMORY_BOUND_RESULTS.md` | `qwen2.5/` and `gemma4/`; T4/Phi summary-only | `run_memory_bound_trace.py` |
| Mixed-traffic workloads | `results/mixed_traffic/MIXED_TRAFFIC_RESULTS.md` §2 | Aggregate raw JSON not included | `run_mixed_traffic.py` |
